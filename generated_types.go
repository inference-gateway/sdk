...
type Endpoints struct {
	// Chat Chat completions endpoint path.
	Chat string `json:"chat"`

	// Models List models endpoint path.
...
func (a ToolCallExtraContent_Google) Get(fieldName string) (value interface{}, found bool) {
...
func (a *ToolCallExtraContent_Google) Set(fieldName string, value interface{}) {
	if a.AdditionalProperties == nil {
